      ...
      <div className=" container-md  text-center ">
        ...
        <Row className="text-start">
          <Col
            md="4"
            sm="6"
            className="card-content px-3 position-relative d-flex flex-column justify-content-between"
          >
            <div className="">
          ...
          <Col
            md="4"
            sm="6"
            className="px-3 position-relative d-flex flex-column justify-content-between"
          >
            <div>
          ...
          >
            <div>
              ...
              <p className="content__body">
                Our company is built around free and open which builds a
                community that keeps everyone honest in how we engineer products
                that users know and love. arrow-white
              </p>
            </div>
