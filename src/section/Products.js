    ...
    <section className="product">
      <Container>
        <Row className="align-items-center justify-content-center py-5">
          <Col lg="7" className="product_title">
            <h1 className="d-lg-block d-none">Search.Observe.</h1>
            <p>
            ...
            <a href="/">
              View all Products<span>&rarr
</span>
            </a>
          </Col>
        </Row>
        <Row className="align-items-center py-5">
          <Col lg="5" className="product_content text-start p-4">
          ...
          <Col lg="5" className="d-lg-block d-sm-none">
            <video width="600" height="400" autoPlay muted>
              <source src={firstVideo}></source>
            </video>
          </Col>
          <Col lg="5" className="product_content text-start p-4 ms-auto">
            <div className="product_logo_container d-flex align-items-center">
          ...
          <Col lg="5" className="product_content text-start p-4">
            ...
            <div className="product_footer ">
              ...
              <div className="bg-light">
                ...
                <div>
                  <img src={volvoLogo} alt="volvo logo"></img>
                  <div class="vr mx-1"></div>
